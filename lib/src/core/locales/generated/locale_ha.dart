...
final CarbonLocaleData localeHaGh = localeHa.copyWith(
  localeCode: 'ha_gh',
);

// Regional variant: ha_NE
final CarbonLocaleData localeHaNe = localeHa.copyWith(
  localeCode: 'ha_ne',
);

// Regional variant: ha_NG
final CarbonLocaleData localeHaNg = localeHa.copyWith(
  localeCode: 'ha_ng',
);
