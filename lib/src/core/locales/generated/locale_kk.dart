// AUTO-GENERATED from PHP Carbon locale: kk
// Do not edit - changes will be overwritten

import 'package:carbon/carbon.dart';

const CarbonLocaleData localeKk = CarbonLocaleData(
  localeCode: 'kk',
  translationStrings: {
    'year': ':count жыл',
...
// Regional variant: kk_KZ
final CarbonLocaleData localeKkKz = localeKk.copyWith(
  localeCode: 'kk_kz',
);
