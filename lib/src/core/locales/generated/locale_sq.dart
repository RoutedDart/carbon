...
final CarbonLocaleData localeSqAl = localeSq.copyWith(
  localeCode: 'sq_al',
);

// Regional variant: sq_MK
final CarbonLocaleData localeSqMk = localeSq.copyWith(
  localeCode: 'sq_mk',
);

// Regional variant: sq_XK
final CarbonLocaleData localeSqXk = localeSq.copyWith(
  localeCode: 'sq_xk',
);
