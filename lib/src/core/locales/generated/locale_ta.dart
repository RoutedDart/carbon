// AUTO-GENERATED from PHP Carbon locale: ta
// Do not edit - changes will be overwritten

import 'package:carbon/carbon.dart';

const CarbonLocaleData localeTa = CarbonLocaleData(
  localeCode: 'ta',
  translationStrings: {
...
// Regional variant: ta_IN
final CarbonLocaleData localeTaIn = localeTa.copyWith(
  localeCode: 'ta_in',
  weekdays: [
    'ஞாயிறு',
    'திங்கள்',
...
// Regional variant: ta_LK
final CarbonLocaleData localeTaLk = localeTa.copyWith(
  localeCode: 'ta_lk',
  weekdays: [
    'ஞாயிறு',
    'திங்கள்',
...
// Regional variant: ta_MY
final CarbonLocaleData localeTaMy = localeTa.copyWith(
  localeCode: 'ta_my',
  weekdays: [
    'ஞாயிறு',
    'திங்கள்',
...
// Regional variant: ta_SG
final CarbonLocaleData localeTaSg = localeTa.copyWith(
  localeCode: 'ta_sg',
  weekdays: [
    'ஞாயிறு',
    'திங்கள்',
