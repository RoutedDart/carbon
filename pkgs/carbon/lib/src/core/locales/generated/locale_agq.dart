// AUTO-GENERATED from PHP Carbon locale: agq
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeAgq = CarbonLocaleData(
  localeCode: 'agq',
  translationStrings: {
  ...
  weekdaysShort: ['nts', 'kpa', 'ghɔ', 'tɔm', 'ume', 'ghɨ', 'dzk'],
  weekdaysMin: ['nts', 'kpa', 'ghɔ', 'tɔm', 'ume', 'ghɨ', 'dzk'],
  firstDayOfWeek: 1,
