// AUTO-GENERATED from PHP Carbon locale: asa
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeAsa = CarbonLocaleData(
  localeCode: 'asa',
  translationStrings: {
  ...
  weekdaysShort: ['Jpi', 'Jtt', 'Jnn', 'Jtn', 'Alh', 'Ijm', 'Jmo'],
  weekdaysMin: ['Jpi', 'Jtt', 'Jnn', 'Jtn', 'Alh', 'Ijm', 'Jmo'],
  firstDayOfWeek: 1,
...
String _meridiem(int hour, dynamic minute, dynamic isLower) {
  return hour < 12 ? 'icheheavo' : 'ichamthi';
}
