// AUTO-GENERATED from PHP Carbon locale: ayc
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeAyc = CarbonLocaleData(
  localeCode: 'ayc',
  translationStrings: {
  ...
  weekdaysShort: ['tum', 'lun', 'mar', 'mir', 'juy', 'wir', 'saw'],
  weekdaysMin: ['tum', 'lun', 'mar', 'mir', 'juy', 'wir', 'saw'],
  firstDayOfWeek: 0,
...
// Regional variant: ayc_PE
final CarbonLocaleData localeAycPe = localeAyc.copyWith(localeCode: 'ayc_pe');
