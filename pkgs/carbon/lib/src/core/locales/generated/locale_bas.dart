// AUTO-GENERATED from PHP Carbon locale: bas
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeBas = CarbonLocaleData(
  localeCode: 'bas',
  translationStrings: {
  ...
  weekdaysShort: ['nɔy', 'nja', 'uum', 'ŋge', 'mbɔ', 'kɔɔ', 'jon'],
  weekdaysMin: ['nɔy', 'nja', 'uum', 'ŋge', 'mbɔ', 'kɔɔ', 'jon'],
  firstDayOfWeek: 1,
...
String _meridiem(int hour, dynamic minute, dynamic isLower) {
  return hour < 12 ? 'I bikɛ̂glà' : 'I ɓugajɔp';
}
