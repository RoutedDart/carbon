// AUTO-GENERATED from PHP Carbon locale: be
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeBe = CarbonLocaleData(
  localeCode: 'be',
  translationStrings: {
...
// Regional variant: be_BY
final CarbonLocaleData localeBeBy = localeBe.copyWith(
  localeCode: 'be_by',
  weekdays: [
    'Нядзеля',
    'Панядзелак',
