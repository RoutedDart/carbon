// AUTO-GENERATED from PHP Carbon locale: ber
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeBer = CarbonLocaleData(
  localeCode: 'ber',
  translationStrings: {
  ...
  weekdaysShort: ['baz', 'bir', 'iki', 'üçü', 'dör', 'beş', 'alt'],
  weekdaysMin: ['baz', 'bir', 'iki', 'üçü', 'dör', 'beş', 'alt'],
  firstDayOfWeek: 6,
...
// Regional variant: ber_DZ
final CarbonLocaleData localeBerDz = localeBer.copyWith(localeCode: 'ber_dz');

// Regional variant: ber_MA
final CarbonLocaleData localeBerMa = localeBer.copyWith(localeCode: 'ber_ma');
