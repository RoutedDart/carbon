// AUTO-GENERATED from PHP Carbon locale: bez
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeBez = CarbonLocaleData(
  localeCode: 'bez',
  translationStrings: {
  ...
  weekdaysShort: ['Mul', 'Vil', 'Hiv', 'Hid', 'Hit', 'Hih', 'Lem'],
  weekdaysMin: ['Mul', 'Vil', 'Hiv', 'Hid', 'Hit', 'Hih', 'Lem'],
  firstDayOfWeek: 1,
...
String _meridiem(int hour, dynamic minute, dynamic isLower) {
  return hour < 12 ? 'pamilau' : 'pamunyi';
}
