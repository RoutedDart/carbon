// AUTO-GENERATED from PHP Carbon locale: brx
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeBrx = CarbonLocaleData(
  localeCode: 'brx',
  translationStrings: {
  ...
  weekdaysShort: ['रबि', 'सम', 'मंगल', 'बुद', 'बिसथि', 'सुखुर', 'सुनि'],
  weekdaysMin: ['रबि', 'सम', 'मंगल', 'बुद', 'बिसथि', 'सुखुर', 'सुनि'],
  firstDayOfWeek: 0,
...
// Regional variant: brx_IN
final CarbonLocaleData localeBrxIn = localeBrx.copyWith(localeCode: 'brx_in');
