// AUTO-GENERATED from PHP Carbon locale: cgg
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeCgg = CarbonLocaleData(
  localeCode: 'cgg',
  translationStrings: {
  ...
  weekdaysShort: ['SAN', 'ORK', 'OKB', 'OKS', 'OKN', 'OKT', 'OMK'],
  weekdaysMin: ['SAN', 'ORK', 'OKB', 'OKS', 'OKN', 'OKT', 'OMK'],
  firstDayOfWeek: 1,
