// AUTO-GENERATED from PHP Carbon locale: dav
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeDav = CarbonLocaleData(
  localeCode: 'dav',
  translationStrings: {
  ...
  weekdaysShort: ['Jum', 'Jim', 'Kaw', 'Kad', 'Kan', 'Kas', 'Ngu'],
  weekdaysMin: ['Jum', 'Jim', 'Kaw', 'Kad', 'Kan', 'Kas', 'Ngu'],
  firstDayOfWeek: 0,
...
String _meridiem(int hour, dynamic minute, dynamic isLower) {
  return hour < 12 ? 'Luma lwa K' : 'luma lwa p';
}
