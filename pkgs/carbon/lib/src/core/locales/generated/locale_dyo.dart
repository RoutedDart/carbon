// AUTO-GENERATED from PHP Carbon locale: dyo
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeDyo = CarbonLocaleData(
  localeCode: 'dyo',
  translationStrings: {
  ...
  weekdaysShort: ['Dim', 'Ten', 'Tal', 'Ala', 'Ara', 'Arj', 'Sib'],
  weekdaysMin: ['Dim', 'Ten', 'Tal', 'Ala', 'Ara', 'Arj', 'Sib'],
  firstDayOfWeek: 1,
