// AUTO-GENERATED from PHP Carbon locale: ebu
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeEbu = CarbonLocaleData(
  localeCode: 'ebu',
  translationStrings: {
  ...
  weekdaysShort: ['Kma', 'Tat', 'Ine', 'Tan', 'Arm', 'Maa', 'NMM'],
  weekdaysMin: ['Kma', 'Tat', 'Ine', 'Tan', 'Arm', 'Maa', 'NMM'],
  firstDayOfWeek: 0,
