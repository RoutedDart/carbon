// AUTO-GENERATED from PHP Carbon locale: ewo
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeEwo = CarbonLocaleData(
  localeCode: 'ewo',
  translationStrings: {
  ...
  weekdaysShort: ['sɔ́n', 'mɔ́n', 'smb', 'sml', 'smn', 'fúl', 'sér'],
  weekdaysMin: ['sɔ́n', 'mɔ́n', 'smb', 'sml', 'smn', 'fúl', 'sér'],
  firstDayOfWeek: 1,
...
String _meridiem(int hour, dynamic minute, dynamic isLower) {
  return hour < 12 ? 'kíkíríg' : 'ngəgógəle';
}
