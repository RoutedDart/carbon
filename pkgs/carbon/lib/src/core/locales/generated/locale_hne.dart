// AUTO-GENERATED from PHP Carbon locale: hne
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeHne = CarbonLocaleData(
  localeCode: 'hne',
  translationStrings: {
  ...
  weekdaysShort: ['इत', 'सोम', 'मंग', 'बुध', 'बिर', 'सुक', 'सनि'],
  weekdaysMin: ['इत', 'सोम', 'मंग', 'बुध', 'बिर', 'सुक', 'सनि'],
  firstDayOfWeek: 0,
...
// Regional variant: hne_IN
final CarbonLocaleData localeHneIn = localeHne.copyWith(localeCode: 'hne_in');
...
String _meridiem(int hour, dynamic minute, dynamic isLower) {
  return hour < 12 ? 'बिहिनियाँ' : 'मंझनियाँ';
}
