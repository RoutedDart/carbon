// AUTO-GENERATED from PHP Carbon locale: kam
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeKam = CarbonLocaleData(
  localeCode: 'kam',
  translationStrings: {
  ...
  weekdaysShort: ['Wky', 'Wkw', 'Wkl', 'Wtũ', 'Wkn', 'Wtn', 'Wth'],
  weekdaysMin: ['Wky', 'Wkw', 'Wkl', 'Wtũ', 'Wkn', 'Wtn', 'Wth'],
  firstDayOfWeek: 0,
...
String _meridiem(int hour, dynamic minute, dynamic isLower) {
  return hour < 12 ? 'Ĩyakwakya' : 'Ĩyawĩoo';
}
