// AUTO-GENERATED from PHP Carbon locale: kde
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeKde = CarbonLocaleData(
  localeCode: 'kde',
  translationStrings: {
  ...
  weekdaysShort: ['Ll2', 'Ll3', 'Ll4', 'Ll5', 'Ll6', 'Ll7', 'Ll1'],
  weekdaysMin: ['Ll2', 'Ll3', 'Ll4', 'Ll5', 'Ll6', 'Ll7', 'Ll1'],
  firstDayOfWeek: 1,
