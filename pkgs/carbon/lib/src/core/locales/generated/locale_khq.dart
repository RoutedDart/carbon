// AUTO-GENERATED from PHP Carbon locale: khq
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeKhq = CarbonLocaleData(
  localeCode: 'khq',
  translationStrings: {
  ...
  weekdaysShort: ['Alh', 'Ati', 'Ata', 'Ala', 'Alm', 'Alj', 'Ass'],
  weekdaysMin: ['Alh', 'Ati', 'Ata', 'Ala', 'Alm', 'Alj', 'Ass'],
  firstDayOfWeek: 1,
