// AUTO-GENERATED from PHP Carbon locale: kln
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeKln = CarbonLocaleData(
  localeCode: 'kln',
  translationStrings: {
  ...
  weekdaysShort: ['Kts', 'Kot', 'Koo', 'Kos', 'Koa', 'Kom', 'Kol'],
  weekdaysMin: ['Kts', 'Kot', 'Koo', 'Kos', 'Koa', 'Kom', 'Kol'],
  firstDayOfWeek: 0,
