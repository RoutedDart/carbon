...
final CarbonLocaleData localeKsIn = localeKs.copyWith(localeCode: 'ks_in');
...
final CarbonLocaleData localeKsInDevanagari = localeKs.copyWith(
  ...
  weekdaysShort: ['आथ ', 'चॅ़दुर', 'बोम', 'ब्वद', 'ब्रस', 'शोकुर', 'बटु'],
  weekdaysMin: ['आथ ', 'चॅ़दुर', 'बोम', 'ब्वद', 'ब्रस', 'शोकुर', 'बटु'],
  months: [
    'जनवरी',
    'फ़रवरी',
    'मार्च',
