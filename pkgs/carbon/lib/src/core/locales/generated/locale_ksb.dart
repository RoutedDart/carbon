// AUTO-GENERATED from PHP Carbon locale: ksb
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeKsb = CarbonLocaleData(
  localeCode: 'ksb',
  translationStrings: {
  ...
  weekdaysShort: ['Jpi', 'Jtt', 'Jmn', 'Jtn', 'Alh', 'Iju', 'Jmo'],
  weekdaysMin: ['Jpi', 'Jtt', 'Jmn', 'Jtn', 'Alh', 'Iju', 'Jmo'],
  firstDayOfWeek: 1,
