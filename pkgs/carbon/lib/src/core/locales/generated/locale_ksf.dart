// AUTO-GENERATED from PHP Carbon locale: ksf
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeKsf = CarbonLocaleData(
  localeCode: 'ksf',
  translationStrings: {
  ...
  weekdaysShort: ['sɔ́n', 'lǝn', 'maa', 'mɛk', 'jǝǝ', 'júm', 'sam'],
  weekdaysMin: ['sɔ́n', 'lǝn', 'maa', 'mɛk', 'jǝǝ', 'júm', 'sam'],
  firstDayOfWeek: 1,
