// AUTO-GENERATED from PHP Carbon locale: lu
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeLu = CarbonLocaleData(
  localeCode: 'lu',
  translationStrings: {
  ...
  weekdaysShort: ['Lum', 'Nko', 'Ndy', 'Ndg', 'Njw', 'Ngv', 'Lub'],
  weekdaysMin: ['Lum', 'Nko', 'Ndy', 'Ndg', 'Njw', 'Ngv', 'Lub'],
  firstDayOfWeek: 1,
