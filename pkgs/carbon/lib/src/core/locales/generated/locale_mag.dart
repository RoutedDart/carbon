// AUTO-GENERATED from PHP Carbon locale: mag
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeMag = CarbonLocaleData(
  localeCode: 'mag',
  translationStrings: {
  ...
  weekdaysShort: ['एतवार', 'सोमार', 'मंगर', 'बुध', 'बिफे', 'सूक', 'सनिचर'],
  weekdaysMin: ['एतवार', 'सोमार', 'मंगर', 'बुध', 'बिफे', 'सूक', 'सनिचर'],
  firstDayOfWeek: 0,
...
// Regional variant: mag_IN
final CarbonLocaleData localeMagIn = localeMag.copyWith(localeCode: 'mag_in');
