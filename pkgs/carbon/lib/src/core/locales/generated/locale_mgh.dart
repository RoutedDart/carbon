// AUTO-GENERATED from PHP Carbon locale: mgh
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeMgh = CarbonLocaleData(
  localeCode: 'mgh',
  translationStrings: {
  ...
  weekdaysShort: ['Sab', 'Jtt', 'Jnn', 'Jtn', 'Ara', 'Iju', 'Jmo'],
  weekdaysMin: ['Sab', 'Jtt', 'Jnn', 'Jtn', 'Ara', 'Iju', 'Jmo'],
  firstDayOfWeek: 0,
...
String _meridiem(int hour, dynamic minute, dynamic isLower) {
  return hour < 12 ? 'wichishu' : 'mchochil’l';
}
