// AUTO-GENERATED from PHP Carbon locale: miq
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeMiq = CarbonLocaleData(
  localeCode: 'miq',
  translationStrings: {
  ...
  weekdaysShort: ['san', 'mun', 'tius', 'wens', 'taus', 'prai', 'sat'],
  weekdaysMin: ['san', 'mun', 'tius', 'wens', 'taus', 'prai', 'sat'],
  firstDayOfWeek: 0,
...
// Regional variant: miq_NI
final CarbonLocaleData localeMiqNi = localeMiq.copyWith(localeCode: 'miq_ni');
