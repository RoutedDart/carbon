// AUTO-GENERATED from PHP Carbon locale: mjw
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeMjw = CarbonLocaleData(
  localeCode: 'mjw',
  translationStrings: {
  ...
  weekdaysShort: ['Bhom', 'Ur', 'Dur', 'Tkel', 'Tkem', 'Bhta', 'Bhti'],
  weekdaysMin: ['Bhom', 'Ur', 'Dur', 'Tkel', 'Tkem', 'Bhta', 'Bhti'],
  firstDayOfWeek: 0,
...
// Regional variant: mjw_IN
final CarbonLocaleData localeMjwIn = localeMjw.copyWith(localeCode: 'mjw_in');
