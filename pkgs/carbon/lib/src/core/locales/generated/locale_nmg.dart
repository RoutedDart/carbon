// AUTO-GENERATED from PHP Carbon locale: nmg
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeNmg = CarbonLocaleData(
  localeCode: 'nmg',
  translationStrings: {
  ...
  weekdaysShort: ['sɔ́n', 'mɔ́n', 'smb', 'sml', 'smn', 'mbs', 'sas'],
  weekdaysMin: ['sɔ́n', 'mɔ́n', 'smb', 'sml', 'smn', 'mbs', 'sas'],
  firstDayOfWeek: 1,
