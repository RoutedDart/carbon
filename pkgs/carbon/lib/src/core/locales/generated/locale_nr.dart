// AUTO-GENERATED from PHP Carbon locale: nr
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeNr = CarbonLocaleData(
  localeCode: 'nr',
  translationStrings: {
  ...
  weekdaysShort: ['Son', 'Mvu', 'Bil', 'Tha', 'Ne', 'Hla', 'Gqi'],
  weekdaysMin: ['Son', 'Mvu', 'Bil', 'Tha', 'Ne', 'Hla', 'Gqi'],
  firstDayOfWeek: 0,
...
// Regional variant: nr_ZA
final CarbonLocaleData localeNrZa = localeNr.copyWith(localeCode: 'nr_za');
