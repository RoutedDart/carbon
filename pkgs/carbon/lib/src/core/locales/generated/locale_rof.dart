// AUTO-GENERATED from PHP Carbon locale: rof
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeRof = CarbonLocaleData(
  localeCode: 'rof',
  translationStrings: {
  ...
  weekdaysShort: ['Ijp', 'Ijt', 'Ijn', 'Ijtn', 'Alh', 'Iju', 'Ijm'],
  weekdaysMin: ['Ijp', 'Ijt', 'Ijn', 'Ijtn', 'Alh', 'Iju', 'Ijm'],
  firstDayOfWeek: 1,
...
String _meridiem(int hour, dynamic minute, dynamic isLower) {
  return hour < 12 ? 'kang’ama' : 'kingoto';
}
