// AUTO-GENERATED from PHP Carbon locale: saq
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeSaq = CarbonLocaleData(
  localeCode: 'saq',
  translationStrings: {
  ...
  weekdaysShort: ['Are', 'Kun', 'Ong', 'Ine', 'Ile', 'Sap', 'Kwe'],
  weekdaysMin: ['Are', 'Kun', 'Ong', 'Ine', 'Ile', 'Sap', 'Kwe'],
  firstDayOfWeek: 0,
