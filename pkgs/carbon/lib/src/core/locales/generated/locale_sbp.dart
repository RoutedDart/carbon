// AUTO-GENERATED from PHP Carbon locale: sbp
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeSbp = CarbonLocaleData(
  localeCode: 'sbp',
  translationStrings: {
  ...
  weekdaysShort: ['Mul', 'Jtt', 'Jnn', 'Jtn', 'Alh', 'Iju', 'Jmo'],
  weekdaysMin: ['Mul', 'Jtt', 'Jnn', 'Jtn', 'Alh', 'Iju', 'Jmo'],
  firstDayOfWeek: 1,
...
String _meridiem(int hour, dynamic minute, dynamic isLower) {
  return hour < 12 ? 'Lwamilawu' : 'Pashamihe';
}
