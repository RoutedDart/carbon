// AUTO-GENERATED from PHP Carbon locale: seh
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeSeh = CarbonLocaleData(
  localeCode: 'seh',
  translationStrings: {
  ...
  weekdaysShort: ['Dim', 'Pos', 'Pir', 'Tat', 'Nai', 'Sha', 'Sab'],
  weekdaysMin: ['Dim', 'Pos', 'Pir', 'Tat', 'Nai', 'Sha', 'Sab'],
  firstDayOfWeek: 0,
