// AUTO-GENERATED from PHP Carbon locale: sid
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeSid = CarbonLocaleData(
  localeCode: 'sid',
  translationStrings: {
  ...
  weekdaysShort: ['Sam', 'San', 'Mak', 'Row', 'Ham', 'Arb', 'Qid'],
  weekdaysMin: ['Sam', 'San', 'Mak', 'Row', 'Ham', 'Arb', 'Qid'],
  firstDayOfWeek: 0,
...
// Regional variant: sid_ET
final CarbonLocaleData localeSidEt = localeSid.copyWith(localeCode: 'sid_et');
