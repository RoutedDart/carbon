// AUTO-GENERATED from PHP Carbon locale: the
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeThe = CarbonLocaleData(
  localeCode: 'the',
  translationStrings: {
  ...
  weekdaysShort: ['आइत', 'सोम', 'मंगल', 'बुध', 'बिहि', 'शुक्र', 'शनि'],
  weekdaysMin: ['आइत', 'सोम', 'मंगल', 'बुध', 'बिहि', 'शुक्र', 'शनि'],
  firstDayOfWeek: 0,
...
// Regional variant: the_NP
final CarbonLocaleData localeTheNp = localeThe.copyWith(localeCode: 'the_np');
