// AUTO-GENERATED from PHP Carbon locale: unm
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeUnm = CarbonLocaleData(
  localeCode: 'unm',
  translationStrings: {
  ...
  weekdaysShort: ['ken', 'man', 'tus', 'lel', 'tas', 'pel', 'sat'],
  weekdaysMin: ['ken', 'man', 'tus', 'lel', 'tas', 'pel', 'sat'],
  firstDayOfWeek: 0,
...
// Regional variant: unm_US
final CarbonLocaleData localeUnmUs = localeUnm.copyWith(localeCode: 'unm_us');
