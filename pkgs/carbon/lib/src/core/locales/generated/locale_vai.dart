// AUTO-GENERATED from PHP Carbon locale: vai
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeVai = CarbonLocaleData(
  localeCode: 'vai',
  translationStrings: {
    'year': ':count ꕀ',
    'a_year': ':count ꕀ',
  ...
  weekdaysShort: ['ꕞꕌꔵ', 'ꗳꗡꘉ', 'ꕚꕞꕚ', 'ꕉꕞꕒ', 'ꕉꔤꕆꕢ', 'ꕉꔤꕀꕮ', 'ꔻꔬꔳ'],
  weekdaysMin: ['ꕞꕌꔵ', 'ꗳꗡꘉ', 'ꕚꕞꕚ', 'ꕉꕞꕒ', 'ꕉꔤꕆꕢ', 'ꕉꔤꕀꕮ', 'ꔻꔬꔳ'],
  firstDayOfWeek: 1,
...
final CarbonLocaleData localeVaiLatn = localeVai.copyWith(
  localeCode: 'vai_latn',
  weekdays: [
    'lahadi',
    'tɛɛnɛɛ',
...
// Regional variant: vai_Vaii
final CarbonLocaleData localeVaiVaii = localeVai.copyWith(
  localeCode: 'vai_vaii',
);
