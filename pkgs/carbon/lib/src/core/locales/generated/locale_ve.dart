// AUTO-GENERATED from PHP Carbon locale: ve
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeVe = CarbonLocaleData(
  localeCode: 've',
  translationStrings: {
  ...
  weekdaysShort: ['Swo', 'Mus', 'Vhi', 'Rar', 'ṋa', 'Ṱan', 'Mug'],
  weekdaysMin: ['Swo', 'Mus', 'Vhi', 'Rar', 'ṋa', 'Ṱan', 'Mug'],
  firstDayOfWeek: 0,
...
// Regional variant: ve_ZA
final CarbonLocaleData localeVeZa = localeVe.copyWith(localeCode: 've_za');
