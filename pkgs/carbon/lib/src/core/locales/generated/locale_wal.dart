// AUTO-GENERATED from PHP Carbon locale: wal
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeWal = CarbonLocaleData(
  localeCode: 'wal',
  translationStrings: {
  ...
  weekdaysShort: ['ወጋ ', 'ሳይኖ', 'ማቆሳ', 'አሩዋ', 'ሃሙሳ', 'አርባ', 'ቄራ '],
  weekdaysMin: ['ወጋ ', 'ሳይኖ', 'ማቆሳ', 'አሩዋ', 'ሃሙሳ', 'አርባ', 'ቄራ '],
  firstDayOfWeek: 0,
...
// Regional variant: wal_ET
final CarbonLocaleData localeWalEt = localeWal.copyWith(localeCode: 'wal_et');
