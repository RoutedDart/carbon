// AUTO-GENERATED from PHP Carbon locale: xog
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeXog = CarbonLocaleData(
  localeCode: 'xog',
  translationStrings: {
  ...
  weekdaysShort: ['Sabi', 'Bala', 'Kubi', 'Kusa', 'Kuna', 'Kuta', 'Muka'],
  weekdaysMin: ['Sabi', 'Bala', 'Kubi', 'Kusa', 'Kuna', 'Kuta', 'Muka'],
  firstDayOfWeek: 1,
