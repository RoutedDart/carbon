// AUTO-GENERATED from PHP Carbon locale: yuw
// Do not edit - changes will be overwritten

import 'package:carbonized/carbonized.dart';

const CarbonLocaleData localeYuw = CarbonLocaleData(
  localeCode: 'yuw',
  translationStrings: {
  ...
  weekdaysShort: ['sön', 'mön', 'sin', 'mit', 'soi', 'nen', 'sab'],
  weekdaysMin: ['sön', 'mön', 'sin', 'mit', 'soi', 'nen', 'sab'],
  firstDayOfWeek: 0,
...
// Regional variant: yuw_PG
final CarbonLocaleData localeYuwPg = localeYuw.copyWith(localeCode: 'yuw_pg');
