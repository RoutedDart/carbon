...
void main() {
  group('Carbon.add - days', () {
    ...
    test('addDay adds one day', () {
      final dynamic carbon = Carbon.create(year: 1975, month: 5, day: 31);
    ...
    test('addDay with explicit count', () {
      final dynamic carbon = Carbon.create(year: 1975, month: 5, day: 10);
  ...
  group('Carbon.sub - days', () {
    ...
    test('subDay subtracts one day', () {
      final dynamic carbon = Carbon.create(year: 1975, month: 6, day: 1);
  ...
  group('Carbon.add - weeks', () {
    ...
    test('addWeek adds one week', () {
      final dynamic carbon = Carbon.create(year: 1975, month: 5, day: 21);
  ...
  group('Carbon.sub - weeks', () {
    ...
    test('subWeek subtracts one week', () {
      final dynamic carbon = Carbon.create(year: 1975, month: 5, day: 28);
  ...
  group('Carbon.add - weekdays', () {
    test('addWeekdays with positive value skips weekends', () {
      ...
      final dynamic carbon = Carbon.create(
        year: 2012,
        month: 1,
        day: 4,
        hour: 13,
    ...
    test('addWeekdays with zero', () {
      final dynamic carbon = Carbon.create(year: 2012, month: 1, day: 4);
      final date = carbon.addWeekdays(0);
      expect(date.day, 4);
    });

    test('addWeekdays with negative value', () {
      final dynamic carbon = Carbon.create(year: 2012, month: 1, day: 31);
      final date = carbon.addWeekdays(-9);
      expect(date.day, 18);
    });

    test('addWeekday adds one weekday', () {
      final dynamic carbon = Carbon.create(year: 2012, month: 1, day: 6);
    ...
    test('addWeekday skips weekend', () {
      ...
      final dynamic carbon = Carbon.create(year: 2012, month: 1, day: 7);
      final date = carbon.addWeekday();
